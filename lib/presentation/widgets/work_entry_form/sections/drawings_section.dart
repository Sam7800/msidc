...
class DrawingsSection extends StatefulWidget {
  ...
  @override
  State<DrawingsSection> createState() => _DrawingsSectionState();
}

class _DrawingsSectionState extends State<DrawingsSection> {
